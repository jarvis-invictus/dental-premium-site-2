...
const stats = [
  { value: clinicConfig.stats.patients_treated, label: "Happy Patients", iconName: "Users" },
  { value: `${clinicConfig.doctors[0].experience_years}+`, label: "Years of Practice", iconName: "CalendarDays" },
  { value: clinicConfig.stats.google_rating, label: "Google Rating", iconName: "Star" },
...
const timeline = [
  ...
  { year: "2024", title: `${clinicConfig.stats.patients_treated} Patients Milestone`, desc: `Celebrated serving over ${clinicConfig.stats.patients_treated} patients — a testament to the trust our community places in us.` },
];
