...
export const metadata = {
  ...
  description: `Book an appointment or get directions to ${clinicConfig.name}. Call ${clinicConfig.contact.phone_primary} or WhatsApp us for same-day booking.`,
};
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{clinicConfig.contact.address_full}</p>
                        <a href={clinicConfig.contact.google_maps_url} target="_blank" rel="noopener noreferrer" className="text-xs text-primary-blue hover:underline mt-0.5 inline-block">Get Directions →</a>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <a href={`tel:${clinicConfig.contact.phone_primary}`} className="text-sm text-gray-600 hover:text-primary-blue transition-colors">{clinicConfig.contact.phone_primary}</a>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <a href={`mailto:${clinicConfig.contact.email}`} className="text-sm text-gray-600 hover:text-primary-blue transition-colors">{clinicConfig.contact.email}</a>
                    </div>
                  </div>
                ...
                <div className="bg-red-50 border border-red-200 rounded-2xl p-5 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <a href={`tel:${clinicConfig.contact.phone_primary}`} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-danger text-white text-xs font-semibold rounded-full">
