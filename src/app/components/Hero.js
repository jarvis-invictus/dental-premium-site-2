      ...
      <div className="container-custom relative py-10 sm:py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center min-h-[70vh] sm:min-h-[80vh]">
            ...
            <BlurFade delay={0.38} duration={0.5} inView>
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                <a
                  ...
                  className="inline-flex justify-center items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-full transition-colors shadow-md w-full sm:w-auto"
                >
                ...
                <Link href="/services" className="btn-secondary w-full sm:w-auto text-center justify-center">
                  Explore Services
                </Link>
              </div>
            </BlurFade>
          ...
          >
            ...
            <div
              className="hero-card-bl absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl p-4 hidden lg:flex items-center gap-3 z-10 cursor-default"
              style={{
                opacity: visible ? 1 : 0,
            ...
            <div
              className="hero-card-tr absolute -top-5 -right-5 bg-white rounded-2xl shadow-xl p-4 z-10 text-center min-w-[100px] cursor-default hidden lg:block"
              style={{
                opacity: visible ? 1 : 0,
            ...
            <div
              className="hero-card-ml absolute top-1/2 -left-6 -translate-y-1/2 bg-white rounded-2xl shadow-lg px-4 py-3 z-10 cursor-default hidden lg:block"
              style={{
                opacity: visible ? 1 : 0,
